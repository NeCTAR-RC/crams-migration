...
from rcallocation import for_choices
from rcallocation.allocation_home_choices import ALLOC_HOME_CHOICE
from rcallocation.project_duration_choices import DURATION_CHOICE
from rcallocation.grant_type import GRANT_TYPES
...
class KeystoneUser(models.Model):
    ...
    def __unicode__(self):
        return "{0}, {1}, {2}".format(self.uuid, self.name, self.extra)
